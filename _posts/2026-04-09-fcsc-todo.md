...
Le fichier content une succession de blocs.
On peut afficher le fichier, et le modifier.
La fonction modifier prend un index, et modifier le character à [index*tailledubloc+1].
...
Le but est de trouver un gadget qui permet d'exploiter le contexte.
