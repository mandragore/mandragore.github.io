...
EDIT: ce n'est pas la solution attendue ("intended").
...
EDIT: la réponse attendue était cryptographique, la routine de génération de nombre pseudo aléatoires était faible..
